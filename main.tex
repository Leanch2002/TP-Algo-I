...
\Tipo{}
    ...
    \requiereLargo{ 
        ...
        \existe{a2}{Alumno}{a2\in edr.aula \yLuego puedeCopiarse(a1, a2)}\land\\
        (edr_0 = edr)
    }
    \aseguraLargo{
        \existe{i}{\Z}{0\leq i < \norm{edr.aula[a1]}\yLuego \existe{a2}{Alumno}{
            a2\in edr_0.aula \land\\
            puedeCopiarse(a1, a2)\yLuego
...
\predLargo{esSospechoso}{edr: EdR, a1: Alumno}{
    \existe{a2}{Alumno}{a2 \in edr.entregas \land  puedeCopiarse(a1, a2, edr.aula) \yLuego 
