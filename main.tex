...
\predLargo{coordenadasValidas}{a:Aula, n: \Z}{
...
\predLargo{puedeCopiarse}{aula: Aula, a1, a2: Alumno, i: \Z}{
    a1 \in aula \land a2 \in aula \land \\
    enRangoDeCopiarse(a1, a2) \yLuego \\
...
\predLargo{todosEstudiantesIgualesMenos}{alumnos: \conj{Alumno}, a0, a1: Aula}{
        \paraTodo{a}{Alumno}{(a \in a0 \land a \in a1 \land \lnot(a \in alumnos)) \implicaLuego a1[a] = a0[a]}
}
...
\aux{porcentajeRespuestasIgualAdyacente}{e1, e2: Examen}{\R}
\\    $(\sum_{i=0}^{\norm{e1}-1} IfThenElse((e1[i] = e2[i]),1,0)) \cdot \frac{100}{\norm{e1}}$
\\

\aux{porcentajeIgualAula}{a:Alumno, entregas:dicc\struct{Alumno, Examen}}{\R}
