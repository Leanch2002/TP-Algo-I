...
\Tipo{}
    ...
    \requiereLargo{ 
        ...
        \existe{a2}{Alumno}{a2\in edr.aula \yLuego puedeCopiarse(edr.aula,a1, a2)}\land\\
        (edr_0 = edr)
    }
    \aseguraLargo{
        \existe{i}{\Z}{0\leq i < \norm{edr.aula[a1]}\yLuego \existe{a2}{Alumno}{
            a2\in edr_0.aula \land\\
            puedeCopiarse(edr_0.aula, a1, a2)\yLuego
            respondio(i, edr_0.aula[a2]) \land \lnot(respondio(i,edr_0.aula[a1])) \land
...
\predLargo{puedeCopiarse}{a: Aula, c1, c2: Alumno}{
    enRangoDeCopiarse(c1, c2) \land \\
    \existe{i}{\Z}{0 \leq i \leq \norm{a[c1]} \implicaLuego respondio(i, a[c2]) \land \neg (respondio(i, a[c1]))}
}

% las coordenadas estan dentro del aula y c0 esta a distancia |2| de c1 en x o esta directamente adelante en y
\predLargo{enRangoDeCopiarse}{c1, c2: Alumno}{
    (\norm{c2.c - c1.c} = 2 \land c2.f = c1.f) \lor 
    (c2.c = c1.c \land  c2.f - c1.f = 1)
}

\predLargo{respondio}{
    i: \Z, e: Examen}{0 \leq i < \norm{e} \yLuego 0 \leq e[i] \leq 9
}
