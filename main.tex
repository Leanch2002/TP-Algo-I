...
\predLargo{coordenadaValida}{c1:Coordenada, a:Aula}{0 \leq c1.f < \norm{a} \land 0 \leq c1.c < \norm{a}}
...
\Tipo{}
    ...
    \aseguraLargo{
        ...
        \existe{j}{\Z}{suExamen(a1.coord, edr_0.aula)[j]= "" \land \\
        suExamen(a3.coord, edr_0.aula)[j] \neq ""}\land \\
        (suExamen(a1.coord, edr.aula)[j] = suExamen(a3.coord, edr.aula)[j]) \land\\
        mismosEjerciciosMenos(j, suExamen(a1.coord, edr.aula), suExamen(a1.coord, edr_0.aula))} \yLuego
...
\Tipo{\seq{Examen}}
    ...
    \aseguraLargo{
        ...
        % vv me aseguro de q la coord de a no cambio
        a.coord = a_0.coord \yLuego\\
...
\Tipo{\seq{Alumno}}
    ...
    \aseguraLargo{
        ...
        \\ porcentajeRespuestasIgualAdyacente(a1, a2) > 60} \ \lor \\porcentajeIgualAula(a1, edr.entregas) > 25))}\yLuego
        \\ \norm{edr.copiones} = \norm{res} \yLuego
...
\predLargo{todosEntregaron}{edr: EdR}{
    ...
    \\\paraTodo{c1}{Coordenada}{coordenadaValida(c1,edr.aula) \implicaLuego suExamen(c1, edr.aula) = \langle \rangle}
}
